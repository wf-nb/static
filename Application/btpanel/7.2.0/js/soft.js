var soft = {
    ...
    get_list: function (page, type, search) {
        ...
        bt.soft.get_soft_list(page, type, search, function (rdata) {
            ...
            // }
            if (type == 10) {
                $("#updata_pro_info").html('<div class="alert alert-danger" style="margin-bottom:15px"><strong>安全提醒：第三方插件上架前，宝塔官方进行了安全审计，但可能还存在安全风险，在生产环境使用前请自行甄别 </strong><a class="btn btn-success btn-xs va0" href="https://www.bt.cn/developer/" title="免费入驻" style="margin-left: 8px" rel="noreferrer noopener" target="_blank">免费入驻</a><a class="btn btn-success btn-xs va0" href="https://www.bt.cn/bbs/forum-40-1.html" title="点击获取第三方应用" style="margin-left: 8px" rel="noreferrer noopener" target="_blank">获取第三方应用</a><input type="file" style="display:none;" accept=".zip,.tar.gz" id="update_zip" multiple="multiple"><button class="btn btn-success btn-xs" onclick="soft.update_zip_open()" style="margin-left:8px">导入插件</button></div>')
            } else if (type == 11) {
        ...
        $.post('/deployment?action=GetList', pdata, function (rdata) {
            ...
            if ($(".onekey-type").attr("class") === undefined) {
                ...
                tbody = '<div class="alert alert-info" style="margin-bottom: 10px;">\
                        ...
                        <a class="btn btn-success btn-xs mr5" href="https://www.bt.cn/bbs/thread-33063-1-1.html" target="_blank" rel="noreferrer noopener">免费入驻</a>\
